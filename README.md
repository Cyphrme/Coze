...
## Canon
A **canon** is a list of fields used for normalization, e.g. `["alg","x"]`.
Some Coze objects are canonicalized for creating digests, signing, verification,
and reference. Using a canon, the **canonical form** of an object is generated
by removing fields not appearing in the canon, ordering remaining fields by
