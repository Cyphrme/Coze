...
## Left Padded Hex?
Don't elide beginning 0's. In Hex, 1/16 of hashes will start with 0 and 1/256
will start with a 00, which is a whole "empty" byte.  For decimal preceding 0's
are typically elided. Hex does not omit padding.  For example, in the case of
